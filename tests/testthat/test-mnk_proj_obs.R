...
test_that("mnk_proj_obs monthly mode downloads data", {
  ...
  with_mocked_bindings(download_month_data = mock_download_month_data,.package = "rminka", {
...
test_that("download_month_data handles <10000 monthly records", {
  ...
  with_mocked_bindings(GET = mock_httr_GET_pings,.package = "httr", {
    with_mocked_bindings(get_minka_obs = mock_get_minka_obs,.package = "rminka", {
...
test_that("get_minka_obs handles pagination", {
  ...
  with_mocked_bindings(GET = mock_GET_pagination,.package = "httr", {
    with_mocked_bindings(process_minka_results = function(all_results) { purrr::map_dfr(all_results, ~tibble(id =.x$id)) },.package = "rminka", {
