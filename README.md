...
# rminka <a href="https://dplyr.tidyverse.org"><img src="man/figures/logo1.png" align="right" height="138" /></a>
...
[![Codecov test
coverage](https://codecov.io/gh/Raiservi/rminka/graph/badge.svg)](https://app.codecov.io/gh/Raiservi/rminka)
<!-- badges: end -->
...
\`\` is a toolkit for interacting with the Minka API, providing a
