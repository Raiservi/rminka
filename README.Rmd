...
*   `mnk_places_byname()`: Finds the place´s ID (place_id) for a location using an approximate place name.
*   `mnk_place_sf()`: Returns the `sf` geometry for a place given its place_id, ready for plotting with packages like `ggplot2` or `leaflet`.
