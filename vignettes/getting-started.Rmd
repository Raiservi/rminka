...
prj_names <- prj_names %>% arrange(id)
kable(prj_names[,c(2,5,6,8)])
...
```{r name, include = TRUE , echo=TRUE}
projects <- mnk_user_proj(6)
projects <- projects %>% arrange(id)
kable(unique(projects[1:7,c(1,2,4,6,7)]))
```
