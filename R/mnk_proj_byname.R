...
#' @description Get information on Minka projects selected by a string contained
#' in the project name.
#' @param query A string that is contained in the project name.
#' @return A data frame with all the projects that contain the string with some
