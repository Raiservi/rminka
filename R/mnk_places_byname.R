#' Information about Minka Place by Name
#' Get information about Minka place by part of the place name.
...
mnk_places_byname <- function(query) {
  ...
  q_path <- paste0("/v1/places/autocomplete?q=", as.character(query_parsed),
  sep = "")
  ...
  if (httr::http_error(response)) {
    ...
    message("Minka API request failed. Status code: ",
